...
// Obtener Productos desde la API de C#.NET
async function fetchProducts() {
    try {
        ...
        if (offersContainer) offersContainer.innerHTML = `<div class="loading-placeholder error">No se pudo cargar el menú. Por favor intenta más tarde.</div>`;
        if (productsContainer) productsContainer.innerHTML = `<div class="loading-placeholder error">No se pudo cargar el menú. Por favor intenta más tarde.</div>`;
    }
}
